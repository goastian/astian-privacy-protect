        ...
        <section layout="relative column gap:2 margin:2:0:0">
          <header layout="row items:center gap:1.5" translate="no">
            <div layout="column">
              ...
              <ui-text type="display-m">Alfra Inform</ui-text>
            </div>
          </header>
          <ui-text
            type="body-m"
          ...
          >
            ...
            browser protected by Astian Privacy. The statistics here provide
            transparency about web tracking. To learn more about how Astian Privacy
            keeps its community safe.
          </ui-text>
          <div
        ...
        html`
          ...
          <section layout="column gap:2:5" layout@1120px:print="grid:2:1">
            <div layout="column gap:3" layout@1120px:print="padding">
              <div layout="column gap:2">
                ...
                <ui-text type="body-m" color="secondary">
                  ...
                  Alfra, you can uncover the identities behind every
                  tracker.
                </ui-text>
              </div>
            ...
            <div layout="column gap:3" layout@1120px:print="padding">
              <div layout="column gap:2 relative">
                ...
                <ui-text type="body-m" color="secondary">
                  Uncovers that no two days are alike. With Astian Privacy, you’re
                  protected each day.
                </ui-text>
          ...
          <section layout="column gap:3">
            <div layout="column gap:2 relative">
              ...
              <ui-text type="body-m" color="secondary">
                Astian Privacy maps the ownership structure linking activities to the
            ...
            >
              <div layout="block:center column center gap:2 width:::400px">
                <div layout="column gap:0.5">
                  ...
                  <ui-text type="body-s" color="secondary">
                    Help Astian Privacy fight for a web where privacy is a basic human
                    right.
                  </ui-text>
                </div>
          ...
          <section layout="block:center margin:2:auto:0 width:::960px">
            <ui-text type="body-s" color="secondary">
              All information displayed on the Alfra Tab
              is an aggregate of facts about web trackers. These reports power
              Astian Privacy's anti-tracking technology, protecting the entire
              community.
            </ui-text>
          </section>
        `}
